# Practical Challenges for RxJava2 Basics
...
### Rules
- Fix one test at a time, then move on to the next
- Must use Java 8 syntax, lambdas, method references, etc
- Must not modify, add to, or extend `CountriesService`
...
**Imported from [RxBasicsKata](https://medium.com/@sergii)**
