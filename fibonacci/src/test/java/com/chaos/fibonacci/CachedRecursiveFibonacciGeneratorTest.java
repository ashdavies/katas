...
import com.chaos.fibonacci.CachedRecursiveFibonacciGenerator;
...
public class CachedRecursiveFibonacciGeneratorTest {
        ...
        @Before
        public void setUp() {
            this.generator = new CachedRecursiveFibonacciGenerator(LIMIT);
        }
